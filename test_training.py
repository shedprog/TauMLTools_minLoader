...
@hydra.main(config_path='.', config_name='test_train')
def main(cfg: DictConfig) -> None:
    ...
    with mlflow.start_run(**run_kwargs) as active_run:
        ...
        dataloader = DataLoader(training_cfg, scaling_cfg)
        ...
        mlflow.log_artifact(to_absolute_path("test_training.py"), 'input_cfg')
        mlflow.log_artifact(to_absolute_path("python/common.py"), 'input_cfg')

        # log hydra files
        mlflow.log_artifacts('.hydra', 'input_cfg/hydra')
        mlflow.log_artifact('test_training.log', 'input_cfg/hydra')
